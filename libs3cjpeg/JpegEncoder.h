...
#define IOCTL_JPG_DECODE                _IO(JPEG_IOCTL_MAGIC, 0x00000002)
#define IOCTL_JPG_ENCODE                _IO(JPEG_IOCTL_MAGIC, 0x00000003)
#define IOCTL_JPG_GET_STRBUF            _IO(JPEG_IOCTL_MAGIC, 0x00000004)
#define IOCTL_JPG_GET_FRMBUF            _IO(JPEG_IOCTL_MAGIC, 0x00000005)
#define IOCTL_JPG_GET_THUMB_STRBUF      _IO(JPEG_IOCTL_MAGIC, 0x0000000A)
#define IOCTL_JPG_GET_THUMB_FRMBUF      _IO(JPEG_IOCTL_MAGIC, 0x0000000B)
#define IOCTL_JPG_GET_PHY_FRMBUF        _IO(JPEG_IOCTL_MAGIC, 0x0000000C)
#define IOCTL_JPG_GET_PHY_THUMB_FRMBUF  _IO(JPEG_IOCTL_MAGIC, 0x0000000D)
//giridhar: added the following 4 cases; the values referenced from android
#define IOCTL_JPG_SET_STRBUF			_IO(JPEG_IOCTL_MAGIC, 0x0000000E)
#define IOCTL_JPG_SET_FRMBUF			_IO(JPEG_IOCTL_MAGIC, 0x0000000F)
#define IOCTL_JPG_SET_THUMB_STRBUF		_IO(JPEG_IOCTL_MAGIC, 0x00000012)
#define IOCTL_JPG_SET_THUMB_FRMBUF		_IO(JPEG_IOCTL_MAGIC, 0x00000013)
